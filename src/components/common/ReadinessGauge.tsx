    ...
    <div className="flex flex-col sm:flex-row items-center gap-8 justify-between">
      ...
      <div className="relative w-44 h-44 shrink-0 flex items-center justify-center">
        <svg className="w-full h-full transform -rotate-90" viewBox="0 0 160 160">
          ...
          <circle
            ...
            className={`transition-all duration-700 ease-out ${
              isReady ? 'text-emerald-500' : 'text-slate-900'
            }`}
            strokeWidth="10"
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
          ...
          <span className="text-[10px] font-mono font-semibold uppercase tracking-wider text-slate-400 mt-0.5">
            Readiness
          </span>
        </div>
      </div>
      ...
      <div className="space-y-3 text-center sm:text-left flex-1">
        <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2.5">
          ...
          {showDelta && score >= 80 && (
            <span className="inline-flex items-center gap-0.5 px-2 py-0.5 rounded text-[11px] font-mono font-bold bg-emerald-100 text-emerald-800 border border-emerald-300 animate-bounce">
        ...
        <div className="pt-2 space-y-1">
          <div className="relative w-full h-2 bg-slate-100 rounded-full overflow-hidden">
            <div
              className={`h-full transition-all duration-700 ease-out rounded-full ${
                isReady ? 'bg-emerald-500' : 'bg-slate-900'
              }`}
          ...
          <div className="flex justify-between text-[10px] font-mono text-slate-400">
            ...
            <span className="text-amber-600 font-semibold">80% Target</span>
